function [thrust, Power, Maero, time]=unsteadyBEM(H, Ls, R, B, omega, V_0, rho, delta_t, N, N_element, Theta_pitch, Theta_cone, Theta_tilt, Theta_yaw)
%Initialization 
global W3_100 W3_60 W3_48 W3_36 W3_30 W3_24 blade_data 
...
for i=2:N*2
    ...
    for b=1:B
        ...
        for k=1:N_element
            % k
            [Vrel_y, Vrel_z] = velocity_compute(b, blade_data(k), H, Ls, Wy(b,k,i-1), Wz(b,k,i-1), Theta_wing1(i), Theta_wing2(i), Theta_wing3(i), omega,V_0, Theta_cone ) ;
